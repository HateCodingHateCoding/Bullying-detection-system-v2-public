...
#ifndef _CSI_RV32_GCC_H
#define _CSI_RV32_GCC_H
...
__ALWAYS_STATIC_INLINE unsigned long __lock_irq(void)
{
    unsigned long result;

    __ASM volatile ("csrrc %0, mstatus, %1" : "=r" (result) : "rK" (8) : "memory");

    return (result);
}

__ALWAYS_STATIC_INLINE void __unlock_irq(unsigned long key)
{
    __ASM volatile ("csrs mstatus, %0" : : "r" (key & 8) : "memory");
}

__ALWAYS_STATIC_INLINE unsigned long __is_disable_irq(void)
{
    unsigned long result;
