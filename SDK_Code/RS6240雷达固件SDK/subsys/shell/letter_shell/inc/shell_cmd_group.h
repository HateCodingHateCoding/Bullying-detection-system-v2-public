...
#define     SHELL_CMD_GROUP_FUNC(_group) \
            void SHELL_CMD_GROUP_FUNC_NAME(_group)(void * p0, int p1, int p2) \
...
#define SHELL_EXPORT_CMD_GROUP(_attr, _name, _group, _desc) \
        ...
        SHELL_EXPORT_CMD(_attr|SHELL_CMD_DISABLE_RETURN, _name, SHELL_CMD_GROUP_FUNC_NAME(_group), _desc)

#define SHELL_CMD_GROUP(_name, _group, _desc) \
        SHELL_CMD_GROUP_FUNC(_group) \
        SHELL_EXPORT_CMD(SHELL_CMD_PERMISSION(0) | SHELL_CMD_TYPE(SHELL_TYPE_CMD_MAIN)|SHELL_CMD_DISABLE_RETURN,\
                         _name, SHELL_CMD_GROUP_FUNC_NAME(_group), _desc)
//        SHELL_CMD(_name, SHELL_CMD_GROUP_FUNC_NAME(_group), _desc)
...
#define SHELL_CMD_ITEM(_name, _func, _desc, ...) \
            { \
                .attr.value = SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_MAIN), \
                .data.cmd.name = #_name, \
                .data.cmd.function = (int (*)())_func, \
                .data.cmd.desc = _desc, \
            ##__VA_ARGS__ \
...
#define SHELL_CMD_ITEM_END()    {.data.cmd.name = NULL}
