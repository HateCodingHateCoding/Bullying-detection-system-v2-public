...
extern uint32_t xportGetTime(void);
#define portGET_RUN_TIME_COUNTER_VALUE()        xportGetTime()

#define portCONFIGURE_TIMER_FOR_RUN_TIME_STATS()

extern void vportTaskSwitchOutHook(void);
#define traceTASK_SWITCHED_OUT()                vportTaskSwitchOutHook()

extern void vportTaskSwitchInHook(void);
#define traceTASK_SWITCHED_IN()                vportTaskSwitchInHook()
#endif
...
extern void vPortSuppressTickAndSleep( TickType_t xExpectedIdleTime );
#define portSUPPRESS_TICKS_AND_SLEEP( xExpectedIdleTime ) vPortSuppressTickAndSleep( xExpectedIdleTime )
#endif

#ifndef portSUPPRESS_TICKS_AND_SLEEP_LIGHT
extern void vPortSuppressTickAndSleepLight( TickType_t xExpectedIdleTime );
#define portSUPPRESS_TICKS_AND_SLEEP_LIGHT( xExpectedIdleTime ) vPortSuppressTickAndSleepLight( xExpectedIdleTime )
#endif
