...
{
#if defined(CONFIG_CHIP_CH2201) || defined(CONFIG_CHIP_PANGU) || defined(CONFIG_CHIP_ARIES_AP) || defined(CONFIG_CHIP_DANICA) || defined(CONFIG_CHIP_MERAK) || defined(CONFIG_CHIP_DUBHE) || defined(CONFIG_CHIP_MIZAR) || defined(CONFIG_CHIP_ALKAID) || defined(CONFIG_CHIP_CH6101)
...
#elif defined(CONFIG_CHIP_DANICA) || defined(CONFIG_CHIP_ARIES_AP) || defined(CONFIG_CHIP_MERAK) || defined(CONFIG_CHIP_DUBHE) || defined(CONFIG_CHIP_MIZAR) || defined(CONFIG_CHIP_ALKAID)
