...
#include <string.h>
#include <drv_usart.h>
#if defined CONFIG_CHIP_ERAGON3 || CONFIG_CHIP_SH810 || defined CONFIG_CHIP_SH807 || defined CONFIG_CHIP_SH610 || defined CONFIG_CHIP_SH610M
#include <drv_intc.h>
#endif
#include <drv_pmu.h>
#include <dw_usart.h>
...
int32_t csi_usart_uninitialize(usart_handle_t handle)
{
    ...
    dw_usart_priv_t *usart_priv = handle;
#if defined CONFIG_CHIP_ERAGON3 || CONFIG_CHIP_SH810 || defined CONFIG_CHIP_SH807 || defined CONFIG_CHIP_SH610 || defined CONFIG_CHIP_SH610M
    csi_intc_disable_irq(usart_priv->irq);
#else
