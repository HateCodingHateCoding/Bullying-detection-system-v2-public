export class Constants {
  ...
  static readonly PAGE_LOGIN = 'pages/Account/Login'
  // 固定的key
  static readonly USER_STORE_KEY = "user_store_key" // 用户首选项的key
  static readonly USER_AUTH_KEY = "user_auth_key"
  static readonly USER_TOP_KEY = "user_top_key"
  static readonly USER_FORMID_KEY = "user_formId_key"
  static  CURRENT_CAFFEINE = 0
  static  TODAY_TOTAL_CAFFEINE = 0
  static  COFFEE_STATUS = ""
  static  COFFEE_ADVICE = ""
